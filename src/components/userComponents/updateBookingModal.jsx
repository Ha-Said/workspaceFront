...
import { updateBooking, deleteBooking } from '../../ApiCalls/apiCalls';

export function UpdateBookingModal({ isOpen, toggleModal, booking }) {
  ...
  useEffect(() => {
    ...
    if (booking) {
      ...
      setPricePerHour(booking.workspace.pricePerHour);
    }
  }, [booking]);
                ...
                <div className="grid gap-4 mb-4 grid-cols-2">
                  <div className="col-span-2">
                    <p className="text-sm text-gray-900 dark:text-white">
                      Space: {booking.workspace.name}
                    </p>
                    <p className="text-sm text-gray-900 dark:text-white">
                      This space costs: ${pricePerHour.toFixed(2)} per hour
                    </p>
                  </div>
                  <div className="col-span-2">
                    <label
