...
export function UserModalForm({ isOpen, toggleModal }) {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prevData) => {
      ...
      if (name === 'workspace') {
        const selectedWorkspace = workspaces.find((workspace) => workspace._id === value);
        setPricePerHour(selectedWorkspace ? selectedWorkspace.pricePerHour : 0);
        
      }
const axios = require('axios');
      if (name === 'startTime' || name === 'endTime' || name === 'workspace') {
        calculateTotalCost(updatedData.date, updatedData.startTime, updatedData.endTime, selectedWorkspace.pricePerHour);
      }
